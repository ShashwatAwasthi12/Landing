        ...
        <>
            <div className="container landing-page-right" style={{ display: login ? "" : "none" }}>
                ...
                <div className="landing-form col-md-8">
                    ...
                    <button type="button" onClick={handleLogin} class="btn btn-lg btn-info landing-login">Login</button>
                </div>
                <p>Dont have an Account?<button type="button" class="btn btn-secondary btn-sm" onClick={() => setlogin(!login)}>Create Account</button></p>
            </div>
            {/* ------------------------------------------------------------------------------------------------------------------ */}
            <div className="container landing-page-right" style={{ display: login ? "none" : "" }}>
                <h1>Signup</h1>
                ...
                <div className="landing-form col-md-8">
                    ...
                    <p>Already have an account? <button type="button" class="btn btn-secondary btn-sm" onClick={() => setlogin(!login)}>Login Here</button></p>
